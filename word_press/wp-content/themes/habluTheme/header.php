...
<div class="container-fluid">
	<div class="row">
		<div class="col-xl-12">
			...
			<div class="header-container text-center bgi" style="background-image: url(<?php header_image(); ?>);">
				<div class="header-content table">
					<div class="table-cell">
						<h1 class="site-title hablu-icon">
							<span class="hide hablu-logo"></span>
				...
				<div class="nav-container">
					<nav class="navbar navbar-default navbar-hablu">
						<?php 
							wp_nav_menu( array(
