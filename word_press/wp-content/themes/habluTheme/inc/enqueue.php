...
function hablu_enqueue_scripts(){
	wp_enqueue_style('bootstrap', get_template_directory_uri() . '/script/css/bootstrap.css', array(), '3.2.0', 'all');
	wp_enqueue_style('hablu', get_template_directory_uri() . '/script/css/site.css', array(), '1.0.0', 'all');
	...
	wp_enqueue_script( 'hablu-js', get_template_directory_uri() . '/script/js/hablu.js', 'jquery', '1.0.0', true );
}
