			...
			<?php if(have_posts()) : ?>
				...
				<article>
						<div class="post-image">
							...
							<?php else : ?>
								<img src="<?php bloginfo('template_url'); ?>/img/dummies/blog/img2.jpg" alt="images here flower" />
							<?php endif; ?>
						</div>
						<p><?php the_excerpt(); ?></p>
						<div class="bottom-article">
							<ul class="meta-post">
								<li>
									<i class="icon-calendar"></i><a href="#"> <?php the_time('F j, Y j:i a'); ?></a>
								</li>
								<li>
				...
				<?php endwhile; ?>
			<?php else : ?>
				<p><?php __('SORRY BRO, NO POSTS FOUND'); ?></p>
			<?php endif ; ?>
						...
						<div class="post-slider">
							...
							<div id="post-slider" class="flexslider">
								<ul class="slides">
									...
									<li>
									<img src="<?php bloginfo('template_url'); ?>/img/dummies/blog/img2.jpg" alt="" />
									</li>
									<li>
									<img src="<?php bloginfo('template_url'); ?>/<?php bloginfo('template_url'); ?>/img/dummies/blog/img3.jpg" alt="" />
									</li>
								</ul>
							</div>
							end flexslider
